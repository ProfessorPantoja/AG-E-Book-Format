// Premium Editorial Design - Current "Standard" Mode
export const standardPremiumPrompt = (language: 'pt' | 'en', preserveContent: boolean) => {
...
export const styleMetadata = {
    ...
    description: 'Magazine-quality design with drop caps, pull quotes, and sidebar notes',
    category: 'Editorial',
    bestFor: ['Books', 'Essays', 'Long-form content']
};
